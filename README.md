...
### Post-Install: Atom packages
    apm install atom-beautify atom-terminal autocomplete-plus autocomplete-paths color-pickerlinter linter-pylint merge-conflicts solarized-dark-ui sort-lines
